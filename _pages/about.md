...
I am currently an **Assistant Professor** in the [S2A team](https://s2a.telecom-paris.fr/) at [Télécom Paris, Institut Polytechnique de Paris](https://www.telecom-paris.fr/). 

I was previously a Post-Doctoral researcher in the [Explainable Machine Learning](https://www.eml-munich.de/) group at TUM and Helmholtz Munich, led by Prof. [Zeynep Akata](https://www.eml-munich.de/people/zeynep-akata), and before that at [Télécom Paris, Institut Polytechnique de Paris](https://www.telecom-paris.fr/), with [Florence d'Alché-Buc](https://perso.telecom-paristech.fr/fdalche/) and [Pavlo Mozharovskyi](https://perso.telecom-paristech.fr/mozharovskyi/).

I received my PhD from Université Jean-Monnet Saint-Étienne, conjointly in the [Vision and Learning Lab for Scene Analysis](https://kalisteo.cea.fr/index.php/ai/) at CEA LIST and Data Intelligence research group in [Hubert Curien Laboratory](https://laboratoirehubertcurien.univ-st-etienne.fr/en/index.html), under the supervision of [Amaury Habrard](https://perso.univ-st-etienne.fr/habrarda/).
